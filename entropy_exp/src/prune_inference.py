...
def append_layer_stats_fields(
    ...
    *,
    ...
    for key in (
        ...
        "evidence_reconcile_query_budget",
        "evidence_reconcile_context_budget",
        "evidence_reconcile_max_total_swaps",
        "evidence_query_deficit",
        "evidence_hierarchy_deficit",
        "evidence_representative_deficit",
        "evidence_context_co_deficit",
        "evidence_anchor_count_before",
        "evidence_anchor_count_after_query",
        "evidence_anchor_fraction_before",
        "evidence_anchor_fraction_after_query",
        "evidence_pareto_safe",
        ...
        "evidence_query_current_min_coverage_before",
        "evidence_query_current_min_coverage_after",
        "evidence_query_reference_min_coverage_before",
        "evidence_query_reference_min_coverage_after",
