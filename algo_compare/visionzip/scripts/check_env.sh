...
OFFICIAL_REPO="${OFFICIAL_REPO:-$METHOD_DIR/third_party/VisionZip}"
...
check_path "visionzip package" "$OFFICIAL_REPO/visionzip/__init__.py"
check_path "local LLaVA package" "$REPO_ROOT/llava/__init__.py"
